...
int mover_PC_gpu_launcher_opt(struct particles*, struct particles*, struct particles*, struct EMfield*, struct grid*, struct parameters*);

// void gpu_deallocate(struct EMfield* , struct grid* , struct parameters*);
void gpu_deallocate(struct EMfield* , struct EMfield**, struct grid* , struct grid**, struct parameters**);
